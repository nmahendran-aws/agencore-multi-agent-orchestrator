...
if __name__ == "__main__":
    # Store the agent ARN
    agent_arn = "arn:aws:bedrock-agentcore:us-east-1:471727841202:runtime/mahen_orchestrator_agent-XuZI0g37tH"
    parameter_name = "/agents/mahen_orchestrator_agent_arn"
